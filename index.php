...
<html lang="en">
	<head>
		...
		<!-- FAVICON -->
		<link rel="apple-touch-icon" sizes="180x180" href="client/theme/apple-touch-icon.png">
		<link rel="icon" type="image/png" sizes="32x32" href="client/theme/favicon-32x32.png">
		<link rel="icon" type="image/png" sizes="16x16" href="client/theme/favicon-16x16.png">
		<link rel="manifest" href="client/theme/site.webmanifest">
		<link rel="mask-icon" href="client/theme/safari-pinned-tab.svg" color="#5bbad5">
